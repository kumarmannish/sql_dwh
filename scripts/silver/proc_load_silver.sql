...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT 
            ...
            END AS prd_line,
            prd_start_dt,
            LEAD(DATEADD(DAY, -1, prd_start_dt)) OVER (PARTITION BY prd_nm ORDER BY prd_start_dt) AS prd_end_dt
